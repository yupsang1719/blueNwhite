export const experiences = [
  {
    company: 'Octavia Dental',
    role: 'Web Developer & Marketing Lead',
    period: 'Jun 2026 – Present',
    location: 'Remote · Godalming, Surrey',
    current: true,
    type: 'dev',
    highlights: [
      'Built and maintain the multi-branch website platform — one codebase powering 3 live branded practice sites, with new branches deployable as a config/content change.',
      'Built the internal admin system: CQC-standard stock/inventory and equipment & facilities logging, replacing manual spreadsheets.',
      'Integrated the Dentally API to pull consenting patients\' emails post-appointment, triggering automated review-request emails.',
      'Lead marketing for the company — SEO, content, local-search landing pages, and campaign strategy across all branches.',
    ],
    tech: ['React', 'Node.js', 'Express', 'MongoDB', 'JWT'],
    links: [{ label: 'View project', href: '/projects/octavia-dental' }],
  },
  {
  ...
  },
  {
    ...
    type: 'admin',
    highlights: [
      'Handled legal assessments and compliance documentation to keep operations within regulatory requirements.',
      'Managed day-to-day business operations, scheduling, and internal coordination.',
      'Supported directors with administrative tasks, record-keeping, and company compliance.',
    ],
  ...
  },
  {
    ...
    type: 'admin',
    highlights: [
      'Assisted with legal assessments and ensured company operations met compliance standards.',
      'Handled administrative duties including record-keeping and operational logistics.',
      'Maintained communication with directors and external stakeholders on business matters.',
    ],
    reference: 'Om Prakesh Gurung, Director',
    tech: [],
    links: [],
